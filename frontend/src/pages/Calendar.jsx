  ...
  import { calendarImage } from '../assets'; // Import your background image
  ...
  const Calendar = () => {
    ...
    return (
      <div 
        ...
        style={{ backgroundImage: `url(${calendarImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }} // Set the image as background
      >
        ...
        <div className="flex justify-between w-full max-w-7xl gap-10 pb-15">
          ...
          <div className="flex flex-col items-center gap-8 w-1/4">
            ...
            <div className="shadow-xl w-full p-6 rounded-md flex flex-col items-center bg-transparent bg-opacity-90 backdrop-blur-lg">
              {/* Year Selector */}
              <select 
                value={selectedDate.getFullYear()} 
                onChange={handleYearChange}
                className="p-2 mb-4 w-full text-lg bg-white rounded-md  text-color-7"
              >
              ...
              <select 
                ...
                className="p-2 w-full text-lg bg-white rounded-md text-color-7"
              >
            ...
            <div className="flex flex-col gap-6 w-full">
              {/* Recent Events */}
              <div className="bg-white shadow-md p-6 rounded-md text-color-5 border-2 border-red-500">
                <h2 className="text-xl font-semibold mb-3">Recent Events</h2>
                <ul>
                  {events.recent.map((event, i) => (
                    <li key={i} className="p-1">{event}</li>
                  ))}
                </ul>
              </div>
              ...
              {/* Upcoming Events */}
              <div className="bg-white shadow-md p-6 rounded-md text-color-5 border-2 border-blue-500">
          ...
          {/* Days Container */}
          <div className="shadow-xl w-3/4 p-8 rounded-md bg-transparent bg-opacity-90 backdrop-blur-lg">
            {/* Weekday headers */}
            ...
            <div className="grid grid-cols-7 gap-4 text-center mt-4">
              {calendarDays.map((day, i) => (
                day ? (
                  <div 
                    key={i} 
                    className="p-4 bg-white rounded shadow-md cursor-pointer h-24 text-black"
