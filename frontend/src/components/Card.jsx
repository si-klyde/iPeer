...
const ProfileCard = () => {
  return (
    <>
      {/* Connect */}
      <div className="mx-5 relative w-[30rem] md:w-[25rem] sm:w-full h-full bg-slate-50 rounded-md pt-24 pb-8 px-4 shadow-xl flex flex-col items-center">
        <div className="border-2 border-solid border-black absolute rounded-lg bg-white size-20 p-6 z-10 -top-8 shadow-xl">
          <div className="bg-transparent w-full h-full overflow-auto">
            <SparklesIcon className="w-auto h-auto" />
          </div>
        </div>
        <label className="font-bold text-n-8 text-lg">
          Unique Approach
        </label>
